...
p.box('browser','User and administrator browser',['Web UI: webui.localhost:3000','Click “Continue with DDA SSO”','Direct Dex email/password form','No second profile form','Existing Keycloak session enables SSO'],65,245,340,245)
...
p.box('roles','EXPLICIT AUTHORIZATION',['Five personas → webui-user → user','Dedicated admin → webui-admin → admin','Admin also: realm-management/realm-admin','Master admin remains separate','No email-based automatic account merge'],65,865,1000,235,'green','#F0FAF5')
